...
@interface MCNavigationController () <UIGestureRecognizerDelegate, UINavigationControllerDelegate>

@property (nonatomic, readonly) MCNavigationBar *navigationBar;
...
- (instancetype)initWithNavigationBarClass:(Class)navigationBarClass toolbarClass:(Class)toolbarClass {
    NSAssert([navigationBarClass isSubclassOfClass:[MCNavigationBar class]], @"navigationBarClass Must be a subclass of MCNavigationBar");
...
-(void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated{
    ...
    if (self.viewControllers.count > 0){
        ...
        UIButton *leftBtn = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, -5, 45)];
