//
//  UIViewController+MC.m
//  NavTestForMarco
//
//  Created by Marco on 2018/11/23.
...
@implementation UIViewController (MC)
...
- (void)hbd_setNeedsUpdateNavigationBar {
    if (self.navigationController && [self.navigationController isKindOfClass:[MCNavigationController class]]) {
        MCNavigationController *nav = (MCNavigationController *)self.navigationController;
